...
public class Orcamento {
  ...
  public Orcamento(){}
  public Orcamento(Cliente clienteOrcamento, Automovel automovelOrcamento, Pecas pecasOrcamento, Servico servicoOrcamento) throws InformacaoInvalida{
	...
	/*GET E SET PREÇO TOTAL DO ORÇAMENTO*/
	  ...
	  public void setTotalOrcamento(double totalOrcamento) throws InformacaoInvalida {
	    if (totalOrcamento >= 0) {  
	    	this.totalOrcamento = totalOrcamento;
	    }
	    else 
	    	throw new InformacaoInvalida("O valor do orçamento não pode ser negativo");
	 }
}
